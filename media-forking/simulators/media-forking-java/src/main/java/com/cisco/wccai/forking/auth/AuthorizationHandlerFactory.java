package com.cisco.wccai.forking.auth;
...
public class AuthorizationHandlerFactory {
    ...
    /**
     * Extract the bearer token from the raw {@code authorization} header. The factory accepts both
     * {@code "Bearer <token>"} and bare token formats (both forms are seen in practice).
     */
