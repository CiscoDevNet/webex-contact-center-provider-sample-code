...
public final class GrpcContextHelper {
    ...
    /** Sets the rpc id on the supplied metadata (overwrites any existing value). */
    public static void addRpcIdToMetadata(Metadata metadata, String rpcId) {
        metadata.removeAll(RPC_ID_KEY);
        metadata.put(RPC_ID_KEY, rpcId);
    }
}
